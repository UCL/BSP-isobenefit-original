...
def create_arg_parser():
    ...
    parser.add_argument("--n-steps", required=True, type=int, help="number of steps for the simulation")

    parser.add_argument("--size-x", required=True, type=int, help="width of the land map")

    parser.add_argument("--size-y", required=True, type=int, help="height of the land map")
    ...
    parser.add_argument(
        "--neighboring-centrality-probability",
        required=False,
        type=float,
        default=5e-3,
    ...
    parser.add_argument(
        "--isolated-centrality-probability",
        required=False,
        type=float,
        default=1e-1,
